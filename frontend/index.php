...
<body class="body">
	...
	<section class="home">
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h1 class="home__title"><b>ENJOY THE MOVIES AND KIDS ENTERTAINMENT</b> AT A CHEAPER RATE</h1>
				...
				<div class="row">
					<div class="col-12">
						<div class="header__search-content">
							<input type="text" placeholder="Enter your email to enjoy limitless entertainment">
				...
				<div class="col-12 col-sm-4 col-md-3">
					...
					<ul class="footer__list">
						<li><a href="tel:+25470790335">+254707903355</a></li>
						<li><a href="mailto:support@mellow.com">support@mellow.com</a></li>
					</ul>
