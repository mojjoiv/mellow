			...
			<div class="row">
				<div class="col-12 col-md-6">
					<div class="faq">
						...
						<p class="faq__text">All the Lorem Ipsum generators on the 
							Internet tend to repeat predefined chunks as necessary,
							 making this the first true generator on the Internet.</p>
						<p class="faq__text">Various versions have evolved over the years,
							 sometimes by accident, sometimes on purpose (injected humour and the like).</p>
					</div>

					<div class="faq">
						<h3 class="faq__title">Why isn't there a HD version of this video?</h3>
						<p class="faq__text">Many desktop publishing packages and web page editors
					...
					<div class="faq">
						...
						<p class="faq__text">There are many variations of passages of Lorem Ipsum available, 
					...
					<div class="faq">
						...
						<p class="faq__text">If you are going to use a passage of Lorem Ipsum, you need to 
				...
				<div class="col-12 col-md-6">
					<div class="faq">
						...
						<p class="faq__text">The point of using Lorem Ipsum is that it has a more-or-less 
					...
					<div class="faq">
						...
						<p class="faq__text">It uses a dictionary of over 200 Latin words, combined with a 
