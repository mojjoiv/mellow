	...
	<section class="section">
		<div class="container">
			<div class="row">
				...
				<!-- section text -->
				<div class="col-12">
					<p class="section__text">It is a long <b>established</b> fact that a reader will be distracted by the readable content of a 
			...
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-4">
					<div class="how">
						...
						<p class="how__text">It has never been an issue to find an old movie or TV show on the internet. However, this is not the 
							case with the new releases.</p>
					</div>
				</div>
				<!-- ebd how box -->
